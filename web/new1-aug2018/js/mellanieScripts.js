...
function slant(){
	...
	$('.slant').css('top', + slantPosition + 'px' );
	$('.slant').css('border-bottom-width', + slantHeight + 'px ');
	$('.slant').css('border-right-width', + slantWidth + 'px');
	$('.slant-2').css('border-top-width', + slantHeight + 'px ');
	$('.slant-2').css('border-right-width', + slantWidth + 'px');
};
...
function parallax(){
    ...
    $('*[class^="parallax"]').each(function(){
    	...
    	$(window).scroll(function(){
        	...
        	$(parallaxImage).css('top', -(scrolled * 0.5) + 'px'); 
   		});
	});
};
